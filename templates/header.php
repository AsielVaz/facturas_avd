                ...
                <div class="dropdown topbar-item">
                    <a class="topbar-button p-0" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="d-flex align-items-center gap-2">
                            <span class="rounded-circle bg-primary-subtle text-primary d-inline-flex align-items-center justify-content-center flex-shrink-0" style="width:32px;height:32px" aria-hidden="true"><i data-lucide="user-round" class="fs-18"></i></span>
